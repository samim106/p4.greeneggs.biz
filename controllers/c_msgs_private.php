...
class msgs_private_controller extends base_controller {
	...
	public function index() {
		# Set up the View
		$this->template->content = View::instance('v_msgs_private');
	...
	public function p_add_one($receiver_id) {
